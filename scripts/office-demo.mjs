...
async function main() {
  ...
  await scene('cab', async () => {
    ...
    await page.getByText('Floor 2 · of 5').waitFor({ timeout: 12_000 })
    await hold(page, 800)
  ...
  await scene('exec-peek', async () => {
    ...
    await page.getByText('Floor 5 · of 5').waitFor({ timeout: 12_000 })
    await hold(page, 800)
    await step(page, 'ArrowDown', 3)
    await step(page, 'ArrowRight', 2)
    await hold(page, 1600)
  ...
  await scene('the-climb', async () => {
    ...
    await hold(page, 1000)
    await page.getByRole('option', { name: /EXEC/ }).click()
    await page.getByText('THE CLIMB').waitFor({ timeout: 10_000 })
