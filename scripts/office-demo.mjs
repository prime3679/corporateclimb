 ...
 * wings. The surround outside the canvas is `--cc-bg` (#12141a, the
 * night-lobby midtone boot from #125), not the old frame black #06080c —
 * the cards and letterbox pad stay 0x070b12 on purpose (they are not the
 * theater).
