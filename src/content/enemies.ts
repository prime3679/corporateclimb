...
export const ENEMIES: Enemy[] = [
  {
    ...
    defeat: 'The intern updates their LinkedIn headline to "open to shadowing."',
  ...
  },
  {
    ...
    defeat: 'The standup ends in six minutes. Nobody knows what to do with the time.',
  ...
  },
  {
    ...
    defeat: 'The paradigm shifts without scheduling a follow-up.',
  ...
  },
  {
    ...
    defeat: 'The final invoice arrives before the recommendations do.',
  ...
  },
  {
    ...
    defeat: 'The cap table goes quiet. For the first time, nobody says "rocket ship."',
    title: 'THE FOUNDER',
...
export const ENEMY_POOLS: Enemy[][] = [
  ...
  [
    ENEMIES[0], // Intern
    {
      ...
      defeat: '"I just wanted the all-hands lunch to feel like governance."',
  ...
  [
    ENEMIES[2], // Overachiever
    {
      ...
      defeat: '"You can have the credit. It\'s on slide 47, in 8-point font."',
  ...
  [
    ENEMIES[6], // C-Suite Boss
    {
      ...
      defeat: 'The board adjourns. Your motion carries with one performative abstention.',
  ...
  [
    ENEMIES[8], // Head of HR
    {
      ...
      defeat: 'Case dismissed. The paperwork returns to its native swamp.',
  ...
  [
    {
      ...
      defeat: '"Approved. One line item. Don\'t make me regret this."',
  ...
  [
    {
      ...
      defeat: '"I\'ll save my questions for the end. For once."',
  ...
  [
    {
      ...
      defeat: '"You get ONE headcount. Junior. Backfill only."',
  ...
  [
    {
      ...
      defeat: '"I was just following the process. The process has declined to comment."',
  ...
  [
    {
      ...
      defeat: '"Position liquidated. This round is yours. The 13D was fun."',
  ...
  [
    {
      ...
      defeat: '"No further findings. Suspiciously clean, but clean."',
  ...
  [
    {
      ...
      defeat: '"I\'ve seen enough. Disturbingly, you have my vote."',
  ...
  [
    {
      ...
      defeat: '"The truth is out. I\'ve updated the shared drive permissions."',
  ...
  [
    {
      ...
      defeat: '"You\'re not for sale. Annoying, but noted."',
  ...
  [
    {
      ...
      defeat: '"Case closed. Please pretend this interview never happened."',
