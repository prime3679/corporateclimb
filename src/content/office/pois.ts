...
export const POI_INSPECT: Record<PoiId, string> = {
  ...
  poi_break_counter_f3: 'Restores HP and PP for the whole team. Product still has the good machine.',
  ...
  poi_quincy_desk: 'Nameplate: QUINCY, VP PRODUCT. The Now column on his monitor is a blinking cursor.',
  ...
  poi_break_table_f4: 'A champagne flute in a coffee mug. The flute is empty. The mug is also empty.',
  poi_ashford_desk: 'Nameplate: ASHFORD, VP SALES. A flute. No champagne. The Close does not need it.',
  poi_elevator_door_f5: 'The reader is green. There is no 6. The beep is quieter up here.',
  poi_directory_sign_f5: 'FLOOR 5 — EXEC. Antechamber: through the glass. Boardroom: down the hall.',
  ...
  poi_break_counter_f5: 'Restores HP and PP for the whole team. The mugs have no logos. That is the logo.',
  poi_vending_machine_f5: 'Accepts Stock Options. The prices are the same. That feels like a statement.',
  ...
  poi_caldwell_desk: 'Nameplate: CALDWELL, CHIEF EXECUTIVE. No computer. A notepad. One line, blank.',
}
