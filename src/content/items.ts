...
export const ITEMS: Record<ItemId, ItemDef> = {
  ...
  noise_cancelling: {
    ...
    emoji: '\uD83C\uDFA7',
    desc: 'Block out the open-plan chaos. You lock in, Focused.',
    price: 16,
    effect: { status: { id: 'focused', target: 'self' } },
  },
  reply_all_grenade: {
  ...
  pip_notice: {
    ...
    name: 'PIP Notice',
    emoji: '📋',
    desc: '"We need to talk about your performance." Micromanages the enemy (ATK down).',
    price: 18,
  ...
  pager_duty: {
    ...
    name: 'Pager Duty',
    emoji: '🚨',
    desc: 'Their phone buzzes at 3 AM. Burns the enemy out (damage each turn).',
    price: 20,
