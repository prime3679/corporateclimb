...
/* ─── Office tileset (Floors 1–5) ───────────────────────────
   ...
   glyph legend is docs/rpg/floor-2-design.md §1.2; Floors 3–5 are
   docs/rpg/floor-3-5-design.md.
...
const FLOOR_FOR_ZONE: Record<ZoneId, TileName> = {
  ...
  ...(FLOOR_3_ZONE_FLOOR as Record<keyof typeof FLOOR_3_ZONE_FLOOR, TileName>),
  ...(FLOOR_4_ZONE_FLOOR as Record<keyof typeof FLOOR_4_ZONE_FLOOR, TileName>),
  ...(FLOOR_5_ZONE_FLOOR as Record<keyof typeof FLOOR_5_ZONE_FLOOR, TileName>),
}
...
const RUGS: Record<FloorId, Rug[]> = {
  ...
  floor_03: FLOOR_3_RUGS,
  floor_04: FLOOR_4_RUGS,
  floor_05: FLOOR_5_RUGS,
}
...
const WALL_DECOR: Record<FloorId, Record<string, TileName>> = {
  ...
  floor_03: FLOOR_3_WALL_DECOR as Record<string, TileName>,
  floor_04: FLOOR_4_WALL_DECOR as Record<string, TileName>,
  floor_05: FLOOR_5_WALL_DECOR as Record<string, TileName>,
}
...
export function propSprite(
  ...
  switch (g) {
    ...
    case 't': {
      ...
      if (floorId !== 'floor_01') return { name: right ? 'btable_f2_r' : 'btable_f2_l' }
    ...
    case 'i': {
      const dir: Record<FloorId, TileName> = {
        floor_01: 'directory',
        floor_02: 'directory_f2',
        floor_03: 'directory_f3',
        floor_04: 'directory_f4',
        floor_05: 'directory_f5',
      }
      return { name: dir[floorId] }
    }
    case 'p':
    ...
    case 'm':
      return s.shredding
        ...
        : { name: 'shredder_idle' }
    case 'W':
      return { name: 'roadmap_wall' }
    case 'N':
      return { name: 'intake_board' }
    case 'C':
      return { name: 'pipeline_board' }
    case 'U':
      return { name: 'sideboard' }
    default:
      return null
  }
}
